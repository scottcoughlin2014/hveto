...
"""HTML utilities for hveto safety studies
"""
...
from html import (wrap_html, bold_param, html_link, scaffold_plots, fancybox_img, cis_link)
...
def write_hveto_safety_page(rounds, thresh):
    ...
    for round in rounds:
        ...
        page.td(html_link('./hveto-round-%04d-summary.html' % round.n, round.n, target='_blank',
                          title="Jump to round %d details" % round.n), _class=row_class)
        # link name to CIS
        page.td(cis_link(round.winner.name))
